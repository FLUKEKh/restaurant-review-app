...
      console.error('Error adding review:', error);
      // ถ้า error มาจาก validation ของ backend (ที่มี errors array)
...
D           <option value="1">⭐ ต้องปรับปรุง</option>
          </select>
...
            max={new Date().toISOString().split('T')[0]} // ห้ามเลือกวันในอนาคต
          />
        </div>

<button type="submit" disabled={submitting}>
        {submitting ? 'กำลังส่ง...' : 'ส่งรีวิว'}
      </button> {/* <-- เพิ่มแท็กปิดตรงนี้ */}
    </form>
  </div>
  );
}
