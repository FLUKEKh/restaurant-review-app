...
    const restaurantReviews = reviews.filter(r => r.restaurantId === parseInt(restaurantId, 10));
    
...
    
    // 4. อัพเดทค่าใน array
    const updatedRestaurant = restaurants[restaurantIndex];
    updatedRestaurant.averageRating = Math.round(newAverageRating * 10) / 10;
    updatedRestaurant.totalReviews = restaurantReviews.length;
    
    // 5. บันทึกไฟล์
